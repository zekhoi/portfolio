        ...
        <div>
            <div id="skills">
                <div className="container px-8 mx-auto py-4 border-b">
                    ...
                    <div className="grid xl:grid-cols-8 md:grid-cols-4 grid-cols-4 text-center">
                        ...
                        <Fade bottom>
                        <div className="max-w-d h-auto rounded-lg transform transition duration-500 hover:scale-110 p-4">
                            <Image src="/images/icons/dart.png" alt="Dart" width={50} height={50} />
                        </div>
                        </Fade>
                        ...
                        <Fade bottom>
                        <div className="max-w-d h-auto rounded-lg transform transition duration-500 hover:scale-110 p-4">
                            <Image src="/images/icons/react.png" alt="React JS" width={50} height={50} />
                        </div>
                        </Fade>

                        <Fade bottom>
                        <div className="max-w-d h-auto rounded-lg transform transition duration-500 hover:scale-110 p-4">
                            <Image src="/images/icons/flutter.png" alt="Flutter" width={50} height={50} />
                        </div>
                        </Fade>
