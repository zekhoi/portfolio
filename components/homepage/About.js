                    ...
                    <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-2 mx-auto">
                        ...
                        <div className="max-w-d h-auto p-4 my-auto text-white">
                            ...
                            <Link href="https://www.instalgram.com/zekhoi">
                                <button className="text-white bg-two hover:bg-white hover:text-two active:bg-white font-bold px-3 py-2 md:px-3 md:py-2 rounded outline-none focus:outline-none mr-1 mb-1" type="button" style={{ transition: "all .15s ease" }}>
                                    Download CV
                                </button>
                            </Link>
                        </div>
