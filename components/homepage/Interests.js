        ...
        <div>
            <div id="interests">
                <div className="container px-8 mx-auto py-4">
                    <h3 className="text-xl text-center md:text-2xl font-medium py-2 mt-14">Interests</h3>
                    <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-2 mx-auto">
                        <div className="max-w-80 overflow-hidden rounded shadow transform transition duration-500 hover:scale-110 hover:shadow-2xl m-2">
                            <div className="p-6">
                                <div className="max-w-max max-h-max shadow-md rounded-lg bg-black p-3 pb-2">
                                ...
                                <Link href="https://en.wikipedia.org/wiki/Data_science">
                                    <button className="mt-3 text-white bg-black border border-black hover:bg-white hover:text-black active:bg-white font-bold px-3 py-2 md:px-3 md:py-2 rounded outline-none focus:outline-none mr-1 mb-1" type="button" style={{ transition: "all .15s ease" }}>
                                        Learn More
                                    </button>
                                </Link>
                            </div>
                        ...
                        <div className="max-w-80 overflow-hidden rounded shadow transform transition duration-500 hover:scale-110 hover:shadow-2xl m-2">
                            <div className="p-6">
                                <div className="max-w-max max-h-max shadow-md rounded-lg bg-black p-3 p-3 pb-2">
