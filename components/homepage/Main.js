                    ...
                    <div className="container px-8 mx-auto">
                        <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-6 mx-auto">
                            <div className="text-center md:text-left my-auto">
                                ...
                                <h1 className="text-2xl md:text-3xl lg:text-5xl font-medium uppercase my-2">Khoironi Kurnia Syah</h1>
                                <h3 className="text-xl md:text-2xl font-medium mb-4">Full-Stack Developer</h3>
