            ...
            <div id="projects">
                <div className="container px-8 mx-auto py-4 border-b">
                    ...
                    <div className="grid xl:grid-cols-4 md:grid-cols-3 sm:grid-cols-1 gap-2 mx-auto justify-items-center">
                        ...
                        <Fade bottom>
                        <div className="max-w-xs rounded-lg shadow hover:shadow-lg transform transition duration-500 hover:scale-105 m-2">
                            <Image className="object-cover w-full border-b rounded-b-none rounded" src="/images/projects/not.png" alt="Covid Tracker" width={320} height={180}/>
                            <div className="px-6 py-4">
                                ...
                                <div className="flex justify-start gap-2 py-2">
                                    ...
                                    <Image src="/images/icons/nextjs.png" alt="Next JS" width={25} height={25} />
                                    <Image src="/images/icons/tailwind.png" alt="Tailwind" width={25} height={25} />
                                    <Image src="/images/icons/restapi.png" alt="REST API" width={25} height={25} />
                                </div>
                            </div>
                        </div>
                        </Fade>
                        ...
                        <Fade bottom>
                        <div className="max-w-xs rounded-lg shadow hover:shadow-lg transform transition duration-500 hover:scale-105 m-2">
                            <Image className="object-cover w-full border-b rounded-b-none rounded" src="/images/projects/not.png" alt="Anime List" width={320} height={180}/>
                            <div className="px-6 py-4">
                        ...
                        <Fade bottom>
                        <div className="max-w-xs rounded-lg shadow hover:shadow-lg transform transition duration-500 hover:scale-105 m-2">
                            <Image className="object-cover w-full border-b rounded-b-none rounded" src="/images/projects/not.png" alt="React Components" width={320} height={180}/>
                            <div className="px-6 py-4">
